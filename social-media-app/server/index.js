...
mongoose.connect(mongoDB, {useNewUrlParser: true, useUnifiedTopology: true});   // mongoDB가 요구하는 사항, 적어주지 않으면 error가 발생할 수 있다.
...
app.use((err, req, res, next)=>{
    ...
    // 전달받은 status가 없으면 500(Internal Sever Error)로 처리한다
